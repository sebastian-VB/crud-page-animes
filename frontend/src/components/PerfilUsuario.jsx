  ...
  const updateUser = async (e) => {
    ...
    try {
      const response = await axios.put(
        `http://localhost:4000/lr/api/${idUser}`,
        { nombre: nombreU, usuario: emailU }
      );
          ...
          {user != null ? (
            <div className="content-perfil">
              ...
              <div className="button-perfil">
                ...
                >
                  Editar perfil <i className="fa-solid fa-user-pen"></i>
                </button>
              </div>
            </div>
          ) : (
            ...
            <div className="body-perfil">
              <form onSubmit={updateUser}>
                ...
                <div id="modalFooter">
                  <button
                    type="submit"
                    className="btn btn-warning btnModal"
                    data-bs-dismiss="modal"
                  >
                    Editar
                  </button>
